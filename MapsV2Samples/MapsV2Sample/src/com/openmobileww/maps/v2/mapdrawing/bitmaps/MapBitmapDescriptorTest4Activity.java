 ...
 */
public class MapBitmapDescriptorTest4Activity extends FragmentActivity {
    ...
    private BitmapDescriptor getBitmapDescriptor() {
        final TestBitmapFileManager manager = new TestBitmapFileManager(this);
        return BitmapDescriptorFactory.fromPath(manager.getTestBitmapPath());
    }
}