 ...
 */
public class MapBitmapDescriptorTest5Activity extends FragmentActivity {
    ...
    private static final String BITMAP_NAME = "orange_icon.png";
    ...
    private BitmapDescriptor getBitmapDescriptor() {
        return BitmapDescriptorFactory.fromFile(BITMAP_NAME);
    }
}